...
FILES=(
    ...
    "plugin/tokenscope-lib/formatter-cost-sections.ts"
    "plugin/tokenscope-lib/formatter-helpers.ts"
    "plugin/tokenscope-lib/formatter-insight-sections.ts"
    "plugin/tokenscope-lib/context.ts"
    "plugin/tokenscope-lib/metadata.ts"
    "plugin/tokenscope-lib/opencode.ts"
    "plugin/tokenscope-lib/report.ts"
    "plugin/tokenscope-lib/session-workflow.ts"
...
REQUIRED_FILES=(
    ...
    "$OPENCODE_DIR/plugin/tokenscope-lib/formatter-cost-sections.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/formatter-helpers.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/formatter-insight-sections.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/context.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/metadata.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/opencode.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/report.ts"
    "$OPENCODE_DIR/plugin/tokenscope-lib/session-workflow.ts"
